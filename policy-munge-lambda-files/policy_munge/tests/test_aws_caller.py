    ...
    "Policies": [
        {
            ...
            "PolicyId": "policy_three_id",
            "Arn": "arn:iam:123432/Policy/test3",
        },
        {
            "PolicyName": "policy_four",
            "PolicyId": "policy_four_id",
            "Arn": "arn:iam:123432/Policy/test4",
        },
    ],
    "IsTruncated": False,
}
...
class AwsCallerTests(TestCase):
    ...
    def test_get_kms_arn_found_kms(self, mock_describe_key):
        ...
        assert (
            aws_caller.get_kms_arn("/alias/test")
    ...
    def test_get_kms_arn_not_found_kms(self, mock_describe_key):
        mock_describe_key.side_effect = botocore.exceptions.ClientError(
            {"Error": {"Code": "NotFoundException"}}, "KMS"
        )
    ...
    def test_handling_of_detach_role_policy_correct_error(
        self, mock_detach_role_policy, mock_delete_policy, mock_list_policy_versions
    ):
        mock_detach_role_policy.side_effect = botocore.exceptions.ClientError(
            {"Error": {"Code": "NoSuchEntity"}}, "IAM"
        )
    ...
    @patch("aws_caller.iam_client.list_policy_versions")
    @patch("aws_caller.iam_client.detach_role_policy")
    def test_policy_version_deletion_logic(
        self,
        mock_detach_role_policy,
