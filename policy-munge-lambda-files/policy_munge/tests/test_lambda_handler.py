...
mocked_db_response = {
    ...
    "records": [
        [
            {"stringValue": "user_one"},
            {"booleanValue": False},
            {"stringValue": "policy_one"},
            {"stringValue": "group_one"},
        ],
        [
            {"stringValue": "user_two"},
            {"booleanValue": True},
            {"stringValue": "policy_one"},
...
mocked_role_tags_response = [
    {"Key": "InputPolicies-1of20", "Value": "to_be_removed"},
    {"Key": "InputPolicies-18of20", "Value": "to_be_removed"},
    {"Key": "Important-Tag", "Value": "to_be_kept"},
]
...
class LambdaHandlerTests(TestCase):
    ...
    def test_check_roles_exist_and_create_if_not(
        ...
        mock_create_role_and_await_consistency.assert_called_once_with(
            "emrfs_user_two", '{"json": "policy string"}'
        )
    ...
    def test_chunk_policies_and_return_dict_of_policy_name_to_json_CHUNKED(self):
        ...
        assert result.get("emrfs_user_one-2of2") == {
            "Version": "2012-10-17",
            "Statement": [{"test": "statement2"}],
        }
    ...
    def test_tag_role_with_policies_NOT_CHUNKED(self, mock_tag_role: MagicMock):
        ...
        self.assertCountEqual(
            ...
            [
                ...
                {"Key": "InputPolicies-1of1", "Value": "policy_one/policy_two"},
            ],
        )
